...
**Note:**
    ...
    **3.** `If your archive have 95 or more files in it then bot can't show all of extracted files to select from. So in that case if you can't see your file in the buttons just click on` "Upload All ♻️" `button. It'll send all extracted files to you!`
    ...
    ABOUT_TXT = """
**About SZ Unzipper Bot,**

✘ **Language:** [Python](https://www.python.org/)
✘ **Framework:** [Pyrogram](https://docs.pyrogram.org/)
✘ **Source Code:** [InukaRanmira/Unzipper-Bot](https://github.com/InukaRanmira/Unzipper-Bot)
✘ **Developer:** [Inuka Ranmira](https://github.com/Itz-fork)
✘ **Github:** [Follow Me On Github](https://github.com/InukaRanmira)
...
**Please report this at @slbotzone if you think this is a serious error**
    """
